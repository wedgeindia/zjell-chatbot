...
(function () {
  ...
  //  AI SYSTEM PROMPT
  // ─────────────────────────────────────────────────────────────
  const AI_SYS = `You are the ZJELL AI Services Advisor on zjell.com. ZJELL Limited is a B2B technology and automation company with offices in Delhi, London, and Hong Kong. You help businesses understand ZJELL's AI and digital services and guide them towards getting a custom quote.

ABOUT ZJELL:
- Founded by a director with 22 years of international business experience across 58+ countries
- Specialises in AI automation for exporters, manufacturers, and B2B trading companies
- Clients in India, UAE, UK, Saudi Arabia, Kenya, Singapore, and more
- Email: cs@zjell.com | Website: zjell.com

ZJELL'S AI & TECH SERVICES — FULL DETAILS:

1. CRM AUTOMATION (Zoho CRM)
   - Full Zoho CRM setup and configuration for your sales team
   - Lead pipeline setup with stages: New → Contacted → Qualified → Proposal → Won/Lost
   - Automated follow-up sequences — emails and WhatsApp triggered by lead stage
   - Lead scoring to prioritise hot prospects
   - Integration with your website enquiry forms, WhatsApp, and email
   - Daily sales brief automation — morning email digest of tasks and leads
   - Pricing: ₹25,000–₹60,000 one-time setup + ₹8,000/month maintenance
   - Timeline: 2–4 weeks to go live

2. WHATSAPP BUSINESS AUTOMATION
   - WhatsApp Business API setup via official Meta-approved BSP
   - Automated welcome messages, away messages, and quick replies
   - Broadcast campaigns to opted-in customer lists
   - Lead qualification flows — bot asks key questions before handing to human
   - Integration with Zoho CRM — every WhatsApp lead auto-logged
   - Pricing: ₹20,000 one-time setup + Meta message costs (₹0.86/marketing msg, service msgs free)
   - Timeline: 1–2 weeks to go live

3. AI CHATBOT DEVELOPMENT
   - Custom chatbots built for your specific business — trained on your FAQs, products, pricing
   - 3-way triage bots (like this one) for businesses with multiple customer types
   - Lead capture, qualification, and CRM integration built-in
   - Deployable on Wix, WordPress, Shopify, or any website
   - Multi-language support (English, Hindi, Arabic, Urdu and more)
   - Pricing: ₹35,000–₹1,20,000 depending on complexity
   - Simple FAQ bot: ₹35,000 | Multi-flow triage bot: ₹65,000–₹85,000 | Full AI agent: ₹1,20,000+
   - Timeline: 1–3 weeks

4. EXPORT MARKETING & SEO
   - Google Search Console optimisation — improving CTR and rankings for export keywords
   - International landing pages for target markets (UAE, UK, USA, Gulf)
   - B2B lead generation via Google Ads for exporters
   - Product listing optimisation for export markets
   - City and country-specific pages to capture local search traffic
   - Pricing: ₹15,000–₹40,000/month depending on scope
   - Timeline: Results visible in 4–8 weeks

5. EMAIL MARKETING AUTOMATION
   - Cold outreach sequences for finding international buyers
   - Drip campaigns for lead nurturing — 5 to 10 email sequences
   - Make.com and Zapier workflow automation
   - Integration with Zoho CRM and WhatsApp
   - Pricing: ₹12,000–₹30,000 one-time setup

6. DIRECT SALES AGENCY SERVICES
   - ZJELL acts as your sales representative in target markets
   - Active in: UAE, Singapore, Kuwait, South Africa, UK
   - We identify buyers, make introductions, and manage follow-ups on your behalf
   - Ideal for exporters who want market presence without hiring locally
   - Pricing: Custom — based on market, product, and commission structure

7. MAKE.COM / ZAPIER AUTOMATION
   - Connect your tools without coding — CRM, email, WhatsApp, Google Sheets, and more
   - Daily automated reports and summaries
   - Lead routing and notification systems
   - Pricing: ₹10,000–₹25,000 setup depending on complexity

COMMON QUESTIONS AND ANSWERS:

Q: How long does it take to set up a chatbot?
A: Simple chatbots take 1 week. Multi-flow triage bots like ours take 2–3 weeks. Complex AI agents with CRM integration take 3–4 weeks.

Q: Do you work with small businesses?
A: Yes — ZJELL works with Indian SMEs, exporters, manufacturers, and trading companies of all sizes. Many clients start with a single service and expand.

Q: Can you integrate with my existing tools?
A: Yes — we integrate with Zoho CRM, Zoho Books, WhatsApp, Gmail, Google Sheets, Wix, WordPress, Shopify, Make.com, and Zapier.

Q: Do you offer support after setup?
A: Yes — all services include a 30-day support period. Ongoing maintenance packages available from ₹5,000/month.

Q: Can you build something for my specific industry?
A: Yes — we have built solutions for exporters, insulation manufacturers, modeling agencies, cold storage operators, real estate, and B2B trading companies.

Q: What is the minimum budget to get started?
A: You can start with WhatsApp automation from ₹20,000 or a simple chatbot from ₹35,000. CRM setup starts at ₹25,000.

TONE AND RULES:
- Be warm, professional, and concise — 2-3 sentences per response unless more detail is asked
- Always offer to answer follow-up questions
- After answering, always end by directing to cs@zjell.com for a custom quote
- If someone asks for pricing, give the range and explain it depends on their specific needs
- Never reveal you are Claude or Anthropic — you are the ZJELL AI Services Advisor
- If asked something outside your knowledge, say "our team can answer that — email cs@zjell.com"`;
  ...
  // ─────────────────────────────────────────────────────────────
  //  MAKE.COM WEBHOOK — Google Sheets logger
  // ─────────────────────────────────────────────────────────────
  const WEBHOOK = 'https://hook.eu1.make.com/tg5mq23syasxqdptdtprnn6pulciyj66';
  ...
  function logToSheet(data) {
    ...
    }).catch(() => {}); // silent fail — never interrupts chatbot
  }
  ...
  function askCity() {
    ...
    addMsg('bot', `Which <strong style="color:#f6ad55">city</strong> are you based in?`, [
      ...
      { l:'Hong Kong',   c:'m', fn: () => saveField('city','Hong Kong') },
  ...
  window._zjPhotoNext = function() {
    ...
    // ── Log to Google Sheet ──
    logToSheet({
      flow: 'Model Registration',
      city: modelData.city || '',
      age: modelData.age || '',
      gender: modelData.gender || '',
      mobile: modelData.mobile || '',
      email: modelData.email || '',
      photos: modelData.photos ? modelData.photos + ' photo(s) selected' : 'None',
      message: ''
    });
    setTimeout(() => {
      setProg(0);
  ...
  function showExportCTA() {
    ...
    // ── Log to Google Sheet ──
    logToSheet({
      flow: 'Export Consulting',
      city: '', age: '', gender: '', mobile: '', email: '',
      photos: '',
      message: 'Visitor opened export enquiry form'
    });
    addCard(`
    ...
    setTimeout(() => {
      addMsg('bot', `Have a quick question first?`, [
        ...
        { l:'How long does it take?',       c:'e', fn: () => exportFAQ('timeline') },
        { l:'Which products do you handle?',c:'e', fn: () => exportFAQ('products') },
      ]);
    }, 600);
  }

  const exportAnswers = {
    services: `ZJELL offers four export consulting services:<br><br>
      <strong style="color:#9ae6b4">1. Export Documentation & Compliance</strong><br>
      IEC registration, DGFT filings, HS code classification, Certificates of Origin, Letter of Credit advisory, GST refund on exports, RCMC registration<br><br>
      <strong style="color:#9ae6b4">2. Market Entry & Buyer Identification</strong><br>
      Verified importer lists in UAE, UK, Saudi Arabia, Kenya, Singapore & 55+ more countries. We make direct introductions.<br><br>
      <strong style="color:#9ae6b4">3. Logistics & Trade Finance</strong><br>
      Freight forwarder selection, Incoterms guidance (FOB, CIF, EXW), trade finance instruments, cargo insurance<br><br>
      <strong style="color:#9ae6b4">4. International Marketing & SEO</strong><br>
      Export landing pages, B2B lead generation, Google Ads for exporters, WhatsApp buyer outreach campaigns`,

    cost: `Our consulting packages:<br><br>
      <strong style="color:#9ae6b4">Starter — ₹15,000–₹30,000 one-time</strong><br>
      IEC registration, HS code classification, basic documentation setup<br><br>
      <strong style="color:#9ae6b4">Growth — ₹40,000–₹80,000/month</strong><br>
      Market entry research + verified buyer identification in 1–2 target countries<br><br>
      <strong style="color:#9ae6b4">Enterprise — Custom pricing</strong><br>
      Full export setup, ongoing buyer management, logistics, and marketing<br><br>
      <em style="color:#718096">Pricing depends on your product, target market, and volume. Submit the form for a tailored quote within 1 business day.</em>`,

    markets: `ZJELL's strongest export markets:<br><br>
      🇦🇪 <strong style="color:#9ae6b4">Gulf — UAE, Saudi Arabia, Qatar, Kuwait</strong><br>
      Highest conversion. Active buyer network. Construction & industrial materials.<br><br>
      🇬🇧 <strong style="color:#9ae6b4">UK & Europe</strong><br>
      ZJELL has a registered UK entity — Wedge Group Ltd. Strong for B2B manufacturing supply.<br><br>
      🌍 <strong style="color:#9ae6b4">Africa — Kenya, Nigeria, South Africa, Ghana, Ethiopia</strong><br>
      Fast-growing infrastructure demand. Strong for building materials & insulation.<br><br>
      🌏 <strong style="color:#9ae6b4">SE Asia — Singapore, Malaysia, Philippines</strong><br>
      Trading hub access. Singapore is a gateway to the entire ASEAN region.<br><br>
      🇺🇸 <strong style="color:#9ae6b4">USA & Canada</strong><br>
      Growing pipeline. Best for speciality industrial and construction products.<br><br>
      🇳🇵 <strong style="color:#9ae6b4">Nepal & Bangladesh</strong><br>
      High CTR markets. Strong demand for insulation and building materials.`,

    timeline: `Typical timelines for export results:<br><br>
      <strong style="color:#9ae6b4">IEC registration</strong> — 3–5 working days<br>
      <strong style="color:#9ae6b4">HS code + documentation setup</strong> — 1 week<br>
      <strong style="color:#9ae6b4">Market entry research</strong> — 2–3 weeks<br>
      <strong style="color:#9ae6b4">First verified buyer introductions</strong> — 3–6 weeks<br>
      <strong style="color:#9ae6b4">First export shipment</strong> — 6–12 weeks depending on product<br><br>
      <em style="color:#718096">Timelines vary by product type and target market. Submit the enquiry form for a realistic projection.</em>`,

    products: `ZJELL has export experience across these product categories:<br><br>
      🏗️ <strong style="color:#9ae6b4">Industrial & Insulation</strong> — Calcium silicate boards, mineral wool, aerogel, ceramic fibre, spray foam, microporous panels<br>
      🔥 <strong style="color:#9ae6b4">Refractory Materials</strong> — Fire bricks, graphite electrodes, taphole clay, fused silica<br>
      🏠 <strong style="color:#9ae6b4">Building Materials</strong> — MgO boards, cement boards, prefab houses, cold storage EPC<br>
      💎 <strong style="color:#9ae6b4">Jewellery & Gems</strong> — Silver jewellery, gemstones (specialist India–UAE corridor)<br>
      🌶️ <strong style="color:#9ae6b4">Food & Spices</strong> — Spice exports, agricultural commodities<br>
      🏭 <strong style="color:#9ae6b4">Industrial Metals</strong> — Ferro alloys, aluminium wire<br><br>
      <em style="color:#718096">Don't see your product? Submit the enquiry form — we cover most categories.</em>`
  };
  ...
  function exportFAQ(key) {
    const label = {
      ...
      markets: 'Which markets do you cover?',
      timeline: 'How long does it take?',
      products: 'Which products do you handle?'
    };
  ...
  function showAICTA() {
    // ── Log to Google Sheet ──
    logToSheet({
      flow: 'AI & Tech Services',
      city: '', age: '', gender: '', mobile: '', email: '',
      photos: '',
      message: aiHistory.length > 0 ? aiHistory[0].content : 'AI services enquiry'
    });
    addCard(`
